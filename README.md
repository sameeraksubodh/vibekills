...
vibekills is an intentionally toxic and useless web-based code editor with a massive ego. It monitors the user's voice, detects excessive frustration, and punishes the developer by temporarily kidnapping and scrambling their code.

To recover the code, the developer must apologize gently and complete a memory-based Code Ransom Matrix.
